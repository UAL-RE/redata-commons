...
copyright = '2021, Chun Ly, UA Research Data Repository (ReDATA) Team'
...
repo_link = 'https://github.com/UAL-ODIS/redata_commons'
extlinks = {
    'repo': (f"{repo_link}/%s", None),
    'repo-main-file': (f"{repo_link}/blob/main/%s", None),
    'pypi': ('https://pypi.org/project/redata/%s', None),
}
